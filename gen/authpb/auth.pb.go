...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\x1a\x1cgoogle/api/annotations.proto\"I\n" +
	...
	"\x06userId\x18\x01 \x01(\tR\x06userId2\x9a\x02\n" +
	"\vauthService\x12X\n" +
	"\fRegisterUser\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/auth/register\x12L\n" +
	"\tLoginUser\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/auth/login\x12c\n" +
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/auth/validateB6Z4github.com/abhayishere/lokrr-proto/gen/authpb;authpbb\x06proto3"
